((global, factory) => {
	...
	var Node = class {
		...
		descendantsOfType(
			...
			const descendantAddress = C.getValue(
		...
		edit(edit) {
			if (this.startIndex >= edit.oldEndIndex) {
				this.startIndex =
					edit.newEndIndex + (this.startIndex - edit.oldEndIndex);
				let subbedPointRow;
	...
	function parseAnyPredicate(steps, index, operator, textPredicates) {
		...
		if (isCaptureStep(steps[2])) {
			...
			textPredicates[index].push((captures) => {
				...
				return matchAll
					? nodes1.every((n1) =>
							nodes2.some((n2) => compare(n1, n2, isPositive)),
						)
					: nodes1.some((n1) =>
							nodes2.some((n2) => compare(n1, n2, isPositive)),
						);
	...
	var Query = class {
		...
		constructor(language, source) {
			...
			if (!address) {
				...
				const suffix = source
					.slice(errorIndex, errorIndex + 100)
					.split("\n")[0];
		...
		isPatternGuaranteedAtStep(byteIndex) {
			return (
				C._ts_query_is_pattern_guaranteed_at_step(this[0], byteIndex) === 1
			);
		}
	};
...
${body2}`);
			...
			const mod = await C.loadWebAssemblyModule(await bytes, {
				loadAsync: true,
			});
		...
		return async (moduleArg = {}) => {
			...
			var mergeLibSymbols = /* @__PURE__ */ __name((exports, libName2) => {
				for (var [sym, exp] of Object.entries(exports)) {
					...
					if (sym.startsWith("dynCall_") && !Object.hasOwn(Module, sym)) {
						Module[sym] = exp;
					}
				}
			}, "mergeLibSymbols");
			var asyncLoad = /* @__PURE__ */ __name(
			...
			_emscripten_get_now = /* @__PURE__ */ __name(
				() => performance.now(),
				"_emscripten_get_now",
			);
			...
			var _ts_language_name = (Module["_ts_language_name"] = (a0) =>
				(_ts_language_name = Module["_ts_language_name"] =
					wasmExports["ts_language_name"])(a0));
			...
			var _ts_language_field_name_for_id = (Module[
				...
				(_ts_language_field_name_for_id = Module[
					"_ts_language_field_name_for_id"
				] =
			...
			var _ts_lookahead_iterator_delete = (Module[
				...
				(_ts_lookahead_iterator_delete = Module[
					"_ts_lookahead_iterator_delete"
				] =
			...
			var _ts_lookahead_iterator_reset_state = (Module[
				...
				(_ts_lookahead_iterator_reset_state = Module[
					"_ts_lookahead_iterator_reset_state"
				] =
					wasmExports["ts_lookahead_iterator_reset_state"])(a0, a1));
			var _ts_lookahead_iterator_reset = (Module[
			...
			var _ts_lookahead_iterator_current_symbol = (Module[
				...
				(_ts_lookahead_iterator_current_symbol = Module[
					"_ts_lookahead_iterator_current_symbol"
				] =
			...
			var _ts_parser_set_timeout_micros = (Module[
				...
				(_ts_parser_set_timeout_micros = Module[
					"_ts_parser_set_timeout_micros"
				] =
			...
			var _ts_parser_set_included_ranges = (Module[
				...
				(_ts_parser_set_included_ranges = Module[
					"_ts_parser_set_included_ranges"
				] =
			...
			var _ts_query_delete = (Module["_ts_query_delete"] = (a0) =>
				(_ts_query_delete = Module["_ts_query_delete"] =
					wasmExports["ts_query_delete"])(a0));
			...
			var _ts_query_capture_name_for_id = (Module[
				...
				(_ts_query_capture_name_for_id = Module[
					"_ts_query_capture_name_for_id"
				] =
			...
			var _ts_query_capture_quantifier_for_id = (Module[
				...
				(_ts_query_capture_quantifier_for_id = Module[
					"_ts_query_capture_quantifier_for_id"
				] =
			...
			var _ts_query_string_value_for_id = (Module[
				...
				(_ts_query_string_value_for_id = Module[
					"_ts_query_string_value_for_id"
				] =
			...
			var _ts_query_predicates_for_pattern = (Module[
				...
				(_ts_query_predicates_for_pattern = Module[
					"_ts_query_predicates_for_pattern"
				] =
			...
			var _ts_query_start_byte_for_pattern = (Module[
				...
				(_ts_query_start_byte_for_pattern = Module[
					"_ts_query_start_byte_for_pattern"
				] =
			...
			var _ts_query_end_byte_for_pattern = (Module[
				...
				(_ts_query_end_byte_for_pattern = Module[
					"_ts_query_end_byte_for_pattern"
				] =
			...
			var _ts_query_is_pattern_non_local = (Module[
				...
				(_ts_query_is_pattern_non_local = Module[
					"_ts_query_is_pattern_non_local"
				] =
			...
			var _ts_parser_enable_logger_wasm = (Module[
				...
				(_ts_parser_enable_logger_wasm = Module[
					"_ts_parser_enable_logger_wasm"
				] =
			...
			var _ts_parser_included_ranges_wasm = (Module[
				...
				(_ts_parser_included_ranges_wasm = Module[
					"_ts_parser_included_ranges_wasm"
				] =
			...
			var _ts_language_type_is_named_wasm = (Module[
				...
				(_ts_language_type_is_named_wasm = Module[
					"_ts_language_type_is_named_wasm"
				] =
			...
			var _ts_language_type_is_visible_wasm = (Module[
				...
				(_ts_language_type_is_visible_wasm = Module[
					"_ts_language_type_is_visible_wasm"
				] =
					wasmExports["ts_language_type_is_visible_wasm"])(a0, a1));
			var _ts_language_supertypes_wasm = (Module[
			...
			var _ts_tree_root_node_with_offset_wasm = (Module[
				...
				(_ts_tree_root_node_with_offset_wasm = Module[
					"_ts_tree_root_node_with_offset_wasm"
				] =
			...
			var _ts_tree_get_changed_ranges_wasm = (Module[
				...
				(_ts_tree_get_changed_ranges_wasm = Module[
					"_ts_tree_get_changed_ranges_wasm"
				] =
			...
			var _ts_tree_cursor_reset_to_wasm = (Module[
				...
				(_ts_tree_cursor_reset_to_wasm = Module[
					"_ts_tree_cursor_reset_to_wasm"
				] =
			...
			var _ts_tree_cursor_goto_first_child_wasm = (Module[
				...
				(_ts_tree_cursor_goto_first_child_wasm = Module[
					"_ts_tree_cursor_goto_first_child_wasm"
				] =
			...
			var _ts_tree_cursor_goto_last_child_wasm = (Module[
				...
				(_ts_tree_cursor_goto_last_child_wasm = Module[
					"_ts_tree_cursor_goto_last_child_wasm"
				] =
			...
			var _ts_tree_cursor_goto_next_sibling_wasm = (Module[
				...
				(_ts_tree_cursor_goto_next_sibling_wasm = Module[
					"_ts_tree_cursor_goto_next_sibling_wasm"
				] =
			...
			var _ts_tree_cursor_goto_descendant_wasm = (Module[
				...
				(_ts_tree_cursor_goto_descendant_wasm = Module[
					"_ts_tree_cursor_goto_descendant_wasm"
				] =
			...
			var _ts_tree_cursor_goto_parent_wasm = (Module[
				...
				(_ts_tree_cursor_goto_parent_wasm = Module[
					"_ts_tree_cursor_goto_parent_wasm"
				] =
			...
			var _ts_tree_cursor_current_node_id_wasm = (Module[
				...
				(_ts_tree_cursor_current_node_id_wasm = Module[
					"_ts_tree_cursor_current_node_id_wasm"
				] =
			...
			var _ts_tree_cursor_start_position_wasm = (Module[
				...
				(_ts_tree_cursor_start_position_wasm = Module[
					"_ts_tree_cursor_start_position_wasm"
				] =
			...
			var _ts_tree_cursor_end_position_wasm = (Module[
				...
				(_ts_tree_cursor_end_position_wasm = Module[
					"_ts_tree_cursor_end_position_wasm"
				] =
			...
			var _ts_tree_cursor_start_index_wasm = (Module[
				...
				(_ts_tree_cursor_start_index_wasm = Module[
					"_ts_tree_cursor_start_index_wasm"
				] =
			...
			var _ts_tree_cursor_end_index_wasm = (Module[
				...
				(_ts_tree_cursor_end_index_wasm = Module[
					"_ts_tree_cursor_end_index_wasm"
				] =
			...
			var _ts_tree_cursor_current_field_id_wasm = (Module[
				...
				(_ts_tree_cursor_current_field_id_wasm = Module[
					"_ts_tree_cursor_current_field_id_wasm"
				] =
			...
			var _ts_tree_cursor_current_depth_wasm = (Module[
				...
				(_ts_tree_cursor_current_depth_wasm = Module[
					"_ts_tree_cursor_current_depth_wasm"
				] =
			...
			var _ts_tree_cursor_current_node_wasm = (Module[
				...
				(_ts_tree_cursor_current_node_wasm = Module[
					"_ts_tree_cursor_current_node_wasm"
				] =
			...
			var _ts_node_field_name_for_child_wasm = (Module[
				...
				(_ts_node_field_name_for_child_wasm = Module[
					"_ts_node_field_name_for_child_wasm"
				] =
			...
			var _ts_node_children_by_field_id_wasm = (Module[
				...
				(_ts_node_children_by_field_id_wasm = Module[
					"_ts_node_children_by_field_id_wasm"
				] =
			...
			var _ts_node_first_child_for_byte_wasm = (Module[
				...
				(_ts_node_first_child_for_byte_wasm = Module[
					"_ts_node_first_child_for_byte_wasm"
				] =
			...
			var _ts_node_grammar_symbol_wasm = (Module[
			...
			var _ts_node_named_child_count_wasm = (Module[
				...
				(_ts_node_named_child_count_wasm = Module[
					"_ts_node_named_child_count_wasm"
				] =
			...
			var _ts_node_child_wasm = (Module["_ts_node_child_wasm"] = (a0, a1) =>
				(_ts_node_child_wasm = Module["_ts_node_child_wasm"] =
					wasmExports["ts_node_child_wasm"])(a0, a1));
			...
			var _ts_node_child_by_field_id_wasm = (Module[
				...
				(_ts_node_child_by_field_id_wasm = Module[
					"_ts_node_child_by_field_id_wasm"
				] =
			...
			var _ts_node_next_named_sibling_wasm = (Module[
				...
				(_ts_node_next_named_sibling_wasm = Module[
					"_ts_node_next_named_sibling_wasm"
				] =
			...
			var _ts_node_descendant_count_wasm = (Module[
				...
				(_ts_node_descendant_count_wasm = Module[
					"_ts_node_descendant_count_wasm"
				] =
			...
			var _ts_node_child_with_descendant_wasm = (Module[
				...
				(_ts_node_child_with_descendant_wasm = Module[
					"_ts_node_child_with_descendant_wasm"
				] =
			...
			var _ts_node_descendant_for_index_wasm = (Module[
				...
				(_ts_node_descendant_for_index_wasm = Module[
					"_ts_node_descendant_for_index_wasm"
				] =
			...
			var _ts_node_descendant_for_position_wasm = (Module[
				...
				(_ts_node_descendant_for_position_wasm = Module[
					"_ts_node_descendant_for_position_wasm"
				] =
			...
			var _ts_node_descendants_of_type_wasm = (Module[
				...
				(_ts_node_descendants_of_type_wasm = Module[
					"_ts_node_descendants_of_type_wasm"
				] =
			...
			var _ts_node_next_parse_state_wasm = (Module[
				...
				(_ts_node_next_parse_state_wasm = Module[
					"_ts_node_next_parse_state_wasm"
				] =
			...
			var _orig$ts_parser_timeout_micros = (Module[
				...
				(_orig$ts_parser_timeout_micros = Module[
					"_orig$ts_parser_timeout_micros"
				] =
