  ...
  return (
    <div className="p-6">
      <div className="mb-6 flex items-center justify-between">
        ...
        <span className="font-mono text-muted-foreground text-xs">Top {data.length} Repos</span>
      </div>
      ...
      <div className="mt-4 flex flex-wrap gap-3">
        {languages.map((lang) => (
          <span className="flex items-center gap-1.5" key={lang}>
            <span className="h-2 w-2 rounded-full" style={{ backgroundColor: getColor(lang) }} />
