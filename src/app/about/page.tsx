			...
			<section className="border-border border-b">
				<div className="mx-auto max-w-4xl px-6 py-20">
					...
					<p className="mt-6 max-w-2xl font-sans text-lg text-muted-foreground leading-relaxed">
						A deep repository analyzer built to help developers understand their
						codebases better. Visualize architecture, identify hotspots, and get
						AI-powered insights - all while keeping your code private.
					</p>
				</div>
			</section>
					...
					<div className="grid gap-8 md:grid-cols-2">
						<div>
							<p className="mb-4 font-sans text-muted-foreground leading-relaxed">
								Modern codebases grow complex quickly. Developers need better
								tools to understand dependencies, identify risks, and make
								informed decisions about refactoring and architecture.
							</p>
							<p className="font-sans text-muted-foreground leading-relaxed">
								Git Insights Analyzer combines static analysis, dependency
								graphing, and AI to give you actionable insights about your code
								- without storing your source code on our servers.
							</p>
						</div>
					...
					<div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
						{techStack.map((tech) => (
							<div
								...
								key={tech.name}
							>
								<h3 className="mb-1 font-mono text-foreground text-sm">
									{tech.name}
								</h3>
			...
			<section className="border-border border-b bg-secondary/30">
				<div className="mx-auto max-w-4xl px-6 py-20 text-center">
					...
					<p className="mx-auto mb-8 max-w-xl font-sans text-muted-foreground">
						Git Insights Analyzer is fully open source. Contributions, issues,
